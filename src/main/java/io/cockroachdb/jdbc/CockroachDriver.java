...
public class CockroachDriver implements Driver {
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ...
        connectionSettings.setRewriteBatchArrays(Boolean.parseBoolean(
                CockroachProperty.REWRITE_BATCH_ARRAYS.toDriverPropertyInfo(properties).value));
        if (connectionSettings.isRewriteBatchArrays()) {
